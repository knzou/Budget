...
func (x *GetCategoriesResponse) GetCatId() int64 {
	if x != nil {
		return x.CatId
	}
	return 0
...
func (x *GetCategoriesResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetCategoriesResponse) GetTypeId() int64 {
	if x != nil {
		return x.TypeId
	}
	return 0
...
func (x *GetTransactionsResponse) GetTranId() int64 {
	if x != nil {
		return x.TranId
	}
	return 0
...
func (x *GetTransactionsResponse) GetCatId() int64 {
	if x != nil {
		return x.CatId
	}
	return 0
...
func (x *GetTransactionsResponse) GetAmount() int64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_proto_service_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x59, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x43, 0x61,
	...
	,
...
var file_proto_service_proto_goTypes = []interface{}{
	...
	(*GetCategoriesResponse)(nil),   // 1: proto.GetCategoriesResponse
	(*GetTransactionsResponse)(nil), // 2: proto.GetTransactionsResponse
}
var file_proto_service_proto_depIdxs = []int32{
	0, // 0: proto.AddService.getCategories:input_type -> proto.Request
	0, // 1: proto.AddService.getTransactions:input_type -> proto.Request
	1, // 2: proto.AddService.getCategories:output_type -> proto.GetCategoriesResponse
	2, // 3: proto.AddService.getTransactions:output_type -> proto.GetTransactionsResponse
...
func (c *addServiceClient) GetCategories(ctx context.Context, in *Request, opts ...grpc.CallOption) (*GetCategoriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.AddService/getCategories", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) GetTransactions(ctx context.Context, in *Request, opts ...grpc.CallOption) (*GetTransactionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.AddService/getTransactions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AddService_GetCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/GetCategories",
	}
...
func _AddService_GetTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/GetTransactions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
